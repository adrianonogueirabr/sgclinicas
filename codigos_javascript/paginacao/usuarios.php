    ...
    <div class="container">
        <div class="row mt-4 mb-2">
            <div class="col-md-12 d-flex justify-content-between align-items-center">
                ...
                <div>
                    <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#cadUsuarioModal">Novo Usuario</button>
                </div>
            </div>
                ...
                <div>
                    <form class="form">
                        <div class="form-group col-md-12">
                            <input type="text" class="form-control" id="inputPassword2" placeholder="Digite...">
                        </div>                        
                    </form>
                </div>
            </div>
