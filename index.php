                    ...
                    <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                        <form method="post" action="processa-login.php">
                            ...
                            <div data-mdb-input-init class="form-outline mb-4">
                                <input type="text" class="form-control form-control" name="login" required="true" placeholder="Insira o Usuario" />
                            </div>

                            <!-- Password input -->
                            <div data-mdb-input-init class="form-outline mb-3">
                                <input type="password" name="senha" required="true"  class="form-control form-control" placeholder="Insira a Senha" />
                            </div>

                            <div class="text-lg-start mt-4 pt-2">
                                <button type="submit" data-mdb-button-init data-mdb-ripple-init class="btn btn-outline-primary" style="padding-left: 2.5rem; padding-right: 2.5rem;">Acessar Sistema</button>
                            </div>
                            <div class=" d-flex text-center  align-items-center my-4">
                                <small class="text-muted">Sistema de Gestão de Clinicas - Versão 1.05.24</small>
                            </div>                            
                        </form>                        
                    </div>                    
                </div>
